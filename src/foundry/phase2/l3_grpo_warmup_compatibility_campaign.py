...
OUTPUT_NAME = "milestone14b_r2_compatibility.json"
...
def build_compatibility_result(
    *,
    ...
    result: dict[str, object] = {
        "schema_version": 1,
        "compatibility_id": "foundry-l3-grpo-warmup-aware-compatibility-v1",
        "decision": "pass",
...
def run_campaign(root: Path) -> dict[str, object]:
    ...
    raw_root = root / "results/raw/phase2_vetted_corpus/milestone14b_r2/compatibility"
    tracked = root / "results/phase2_vetted_corpus"
    selection = _read(tracked / SELECTION_OUTPUT)
    warmup = _read(tracked / WARMUP_CONTRACT_OUTPUT)
